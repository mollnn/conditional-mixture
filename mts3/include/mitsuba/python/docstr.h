...
static const char *__doc_mitsuba_BSDFSample3_alpha = R"doc(isotropic roughness at the sample)doc";
...
static const char *__doc_mitsuba_BSDF_eval_with_roughness = 
R"doc(Evaluate the BSDF with a given roughness value)doc";

static const char *__doc_mitsuba_BSDF_get_texel_index =
    R"doc(get_texel_index)doc";

static const char *__doc_mitsuba_BSDF_compute_normalmap_deriv =
    R"doc(compute_normalmap_deriv)doc";
...
static const char *__doc_mitsuba_Film_clear = R"doc(Clear the film content to zero.)doc";
